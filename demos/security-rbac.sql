...
GRANT SELECT ON TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.CUSTOMERS TO ROLE west_coast_manager;
GRANT SELECT ON TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.ORDERS TO ROLE west_coast_manager;
GRANT SELECT ON TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.ORDER_ITEMS TO ROLE west_coast_manager;
GRANT SELECT ON TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.PRODUCT_CATALOG TO ROLE west_coast_manager;
GRANT SELECT ON TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.PRODUCT_REVIEWS TO ROLE west_coast_manager;
GRANT SELECT ON TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.SUPPORT_TICKETS TO ROLE west_coast_manager;

-- Grant access to dynamic tables (for Business Insights Agent)
GRANT SELECT ON DASH_AUTOMATED_INTELLIGENCE_DB.DYNAMIC_TABLES.DAILY_BUSINESS_METRICS TO ROLE west_coast_manager;
GRANT SELECT ON DASH_AUTOMATED_INTELLIGENCE_DB.DYNAMIC_TABLES.ENRICHED_ORDERS TO ROLE west_coast_manager;
GRANT SELECT ON DASH_AUTOMATED_INTELLIGENCE_DB.DYNAMIC_TABLES.ENRICHED_ORDER_ITEMS TO ROLE west_coast_manager;
...
GRANT SELECT ON DASH_AUTOMATED_INTELLIGENCE_DB.DYNAMIC_TABLES.BUSINESS_INSIGHTS_SEMANTIC_VIEW TO ROLE west_coast_manager;
...
SELECT * 
FROM TABLE(
    DASH_AUTOMATED_INTELLIGENCE_DB.INFORMATION_SCHEMA.POLICY_REFERENCES(
