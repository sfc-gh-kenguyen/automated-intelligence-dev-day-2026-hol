...
CREATE OR ALTER TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.DEMO_TABLE (
    id INT PRIMARY KEY,
    name VARCHAR(100),
...
-- Views
CREATE OR ALTER VIEW DASH_AUTOMATED_INTELLIGENCE_DB.RAW.demo_view AS
SELECT id, name FROM DASH_AUTOMATED_INTELLIGENCE_DB.RAW.DEMO_TABLE;

-- Stored Procedures
CREATE OR ALTER PROCEDURE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.demo_procedure()
RETURNS VARCHAR
LANGUAGE SQL
AS
BEGIN
...
-- Functions
CREATE OR ALTER FUNCTION DASH_AUTOMATED_INTELLIGENCE_DB.RAW.demo_function(x INT)
RETURNS INT
LANGUAGE SQL
AS
$$
...
-- V1: Initial schema
CREATE OR ALTER TABLE DASH_AUTOMATED_INTELLIGENCE_DB.RAW.USER_EVENTS (
...
-- Cleanup
DROP TABLE IF EXISTS DASH_AUTOMATED_INTELLIGENCE_DB.RAW.DEMO_TABLE;
DROP VIEW IF EXISTS DASH_AUTOMATED_INTELLIGENCE_DB.RAW.demo_view;
DROP PROCEDURE IF EXISTS DASH_AUTOMATED_INTELLIGENCE_DB.RAW.demo_procedure();
DROP FUNCTION IF EXISTS DASH_AUTOMATED_INTELLIGENCE_DB.RAW.demo_function(INT);
